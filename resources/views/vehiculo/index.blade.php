                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        <!-----Editar cliente--->
                                        @can('editar-vehiculo')
                                        <li><a class="dropdown-item" href="{{ route('vehiculos.edit', $vehiculo) }}">Editar</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                ...
                                <div> <!-- Eliminar vehículo -->
                                    @can('eliminar-vehiculo')
                                    <button title="Eliminar" data-bs-toggle="modal" data-bs-target="#confirmModal-{{ $vehiculo->id }}" 
                                ...
                                <div class="modal fade" id="confirmModal-{{ $vehiculo->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
